...
package org.apache.spark.sql.execution.datasources.orc.stream;


import com.facebook.presto.orc.stream.OrcInputStream;
import com.facebook.presto.orc.stream.ValueStream;
import org.apache.spark.sql.execution.datasources.orc.checkpoint.UnboundedIntegerStreamCheckpoint;
        ...
        implements ValueStream<UnboundedIntegerStreamCheckpoint>
{
    ...
    @Override
    public void seekToCheckpoint(UnboundedIntegerStreamCheckpoint checkpoint) throws IOException
    {
        input.seekToCheckpoint(checkpoint.getInputStreamCheckpoint());
    }

    // This comes from the Apache Hive ORC code
    // (see org.apache.hadoop.hive.ql.io.orc.SerializationUtils.java)
            ...
            throws IOException
    {
        ...
        do {
            ...
            long work = 0x7f & b;
            checkState(offset <= 56 || (offset == 63 && work <= 1),
                "Unbounded integer does not fit long");
            result |= work << offset;
            offset += 7;
        }
        while (b >= 0x80);
