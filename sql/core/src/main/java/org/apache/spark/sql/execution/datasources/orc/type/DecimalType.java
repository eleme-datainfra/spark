...
package org.apache.spark.sql.execution.datasources.orc.type;
        ...
        extends AbstractFixedWidthType
{
    ...
    {
        super(new TypeSignature("decimal",
                buildPrecisionScaleList(precision, scale)), javaType, fixedSize);
    ...
    {
        super(new TypeSignature("decimal", emptyList()), long.class, 0);
